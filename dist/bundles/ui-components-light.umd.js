(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/forms'), require('@angular/core'), require('rxjs/Subject'), require('rxjs/symbol/observable'), require('rxjs/Subscription')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/forms', '@angular/core', 'rxjs/Subject', 'rxjs/symbol/observable', 'rxjs/Subscription'], factory) :
	(factory((global['ui-components-light'] = {}),global.ng.common,global.ng.forms,global.ng.core,global.Rx,global.Rx.Symbol,global.Rx));
}(this, (function (exports,common,forms,core,Subject,observable,Subscription) { 'use strict';
...
var ObservableArray = (function (_super) {
    ...
    function ObservableArray(data) {
         ...
         * fixed
         */
        _this.collectionChanged = new core.EventEmitter(true);
        if (data) {
            data = asArray(data);
...
var CollectionView /*extends Observable*/ = (function () {
     ...
     * @return {?}
     */
    CollectionView.prototype[observable.$$observable] = function () {
        return this;
    };
    /**
     * @param {?} subscriber
...
var ListBox = (function (_super) {
    ...
    function ListBox(element, options) {
        ...
        _this._html = false;
        _this._search = '';
        _this.subscription1 = new Subscription.Subscription();
        _this.subscription2 = new Subscription.Subscription();
        /**
...
exports.ɵa = ClrResponsiveNavigationService;
exports.ɵb = Control;
